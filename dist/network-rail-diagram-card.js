      ...
      <ha-card>
        ...
        <div class="diagram-container ${"horizontal"===this.config.layout?"horizontal":""}">
          ...
          ${this.config.show_down_lines&&i.down_stations&&i.down_stations.length>0?I`
            <div class="direction-arrow">↓</div>
            ${i.down_between_berths?.length?I`
