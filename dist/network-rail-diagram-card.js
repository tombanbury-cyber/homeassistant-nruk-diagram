 ...
 */
const e=globalThis,i=e.ShadowRoot&&(void 0===e.ShadyCSS||e.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,s=Symbol(),r=new WeakMap;let o=class{constructor(t,e,i){if(this._$cssResult$=!0,i!==s)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=e}get styleSheet(){let t=this.o;const e=this.t;if(i&&void 0===t){const i=void 0!==e&&1===e.length;i&&(t=r.get(e)),void 0===t&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),i&&r.set(e,t))}return t}toString(){return this.cssText}};const n=i?t=>t:t=>t instanceof CSSStyleSheet?(t=>{let e="";for(const i of t.cssRules)e+=i.cssText;return(t=>new o("string"==typeof t?t:t+"",void 0,s))(e)})(t):t,{is:a,defineProperty:c,getOwnPropertyDescriptor:h,getOwnPropertyNames:l,getOwnPropertySymbols:d,getPrototypeOf:p}=Object,u=globalThis,f=u.trustedTypes,m=f?f.emptyScript:"",g=u.reactiveElementPolyfillSupport,$=(t,e)=>t,_={toAttribute(t,e){switch(e){case Boolean:t=t?m:null;break;case Object:case Array:t=null==t?t:JSON.stringify(t)}return t},fromAttribute(t,e){let i=t;switch(e){case Boolean:i=null!==t;break;case Number:i=null===t?null:Number(t);break;case Object:case Array:try{i=JSON.parse(t)}catch(t){i=null}}return i}},v=(t,e)=>!a(t,e),y={attribute:!0,type:String,converter:_,reflect:!1,useDefault:!1,hasChanged:v};
/**
 * @license
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const at={attribute:!0,type:String,converter:_,reflect:!1,hasChanged:v},ct=(t=at,e,i)=>{const{kind:s,metadata:r}=i;let o=globalThis.litPropertyMetadata.get(r);if(void 0===o&&globalThis.litPropertyMetadata.set(r,o=new Map),"setter"===s&&((t=Object.create(t)).wrapped=!0),o.set(i.name,t),"accessor"===s){const{name:s}=i;return{set(i){const r=e.get.call(this);e.set.call(this,i),this.requestUpdate(s,r,t)},init(e){return void 0!==e&&this.C(s,void 0,t,e),e}}}if("setter"===s){const{name:s}=i;return function(i){const r=this[s];e.call(this,i),this.requestUpdate(s,r,t)}}throw Error("Unsupported decorator location: "+s)};
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let lt=class extends ot{constructor(){super(...arguments),this.defaultPlatformColors={1:"#4CAF50",2:"#2196F3",3:"#FF9800",4:"#9C27B0",5:"#F44336",6:"#009688",7:"#795548",8:"#607D8B"}}setConfig(t){if(!t.entity)throw new Error("You need to define an entity");this.config={layout:"vertical",compact:!1,show_empty_berths:!0,show_alerts:!0,show_train_details:!0,alert_color:"#FF5252",...t,platform_colors:{...this.defaultPlatformColors,...t.platform_colors||{}}}}shouldUpdate(t){return!!this.config}getCardSize(){return 5}getTrainInfo(t,e){if(e&&t)return e.find(e=>e.headcode===t)}formatTimeInDiagram(t){const e=Math.floor(t/60),i=t%60;return e>0?`${e}m ${i}s`:`${i}s`}getPlatformColor(t){return t&&this.config&&this.config.platform_colors?.[t]||"var(--primary-color)"}renderBerth(t,e){if(!this.config)return B``;const i=t.headcode?this.getTrainInfo(t.headcode,e):void 0,s=i?.triggers_alert||!1,r=this.getPlatformColor(t.platform),o=this.config.alert_color||"#FF5252";if(!t.occupied&&!this.config.show_empty_berths)return B``;const n=`berth ${t.occupied?"occupied":"empty"} ${s?"alert":""} ${this.config.compact?"compact":""}`,a=s?o:t.occupied&&t.platform?r:"var(--divider-color)";return B`
      <div 
        class="${n}" 
    ...
    `:B``}renderCenterStation(t){if(!this.config)return B``;const e={stanox:t.center_stanox,name:t.center_name,berths:t.center_berths||[]};return this.renderStation(e,t.trains_in_diagram,!0)}render(){if(!this.config||!this.hass||!this.config.entity)return B``;const t=this.hass.states[this.config.entity],e=t?.state;if(!t||"unavailable"===e||"unknown"===e)return B`
        <ha-card>
          <div class="header">
      ...
      <ha-card>
        <div class="header">
          ...
          ${void 0!==i.total_trains||void 0!==i.alert_trains?B`
            <div class="header-stats">
              ${void 0!==i.total_trains?B`
                <span class="stat-badge">🚂 ${i.total_trains}</span>
              `:""}
              ${void 0!==i.alert_trains&&i.alert_trains>0?B`
        ...
        <div class="diagram-container ${"horizontal"===this.config.layout?"horizontal":""}">
          ${i.up_stations&&i.up_stations.length>0?B`
          ...
          ${i.down_stations&&i.down_stations.length>0?B`
            <div class="direction-arrow">↓</div>
  ...
  `,t([ht({attribute:!1})],lt.prototype,"hass",void 0),t([function(t){return ht({...t,state:!0,attribute:!1})}()],lt.prototype,"config",void 0),lt=t([(t=>(e,i)=>{void 0!==i?i.addInitializer(()=>{customElements.define(t,e)}):customElements.define(t,e)})("network-rail-diagram-card")],lt),window.customCards=window.customCards||[],window.customCards.push({type:"network-rail-diagram-card",name:"Network Rail Diagram Card",description:"Display Network Rail berth occupancy in a graphical diagram",preview:!1,documentationURL:"https://github.com/tombanbury-cyber/homeassistant-nruk-diagram"}),console.info("%c NETWORK-RAIL-DIAGRAM-CARD %c 2.0.0 ","color: white; background: #4CAF50; font-weight: 700;","color: #4CAF50; background: white; font-weight: 700;");export{lt as NetworkRailDiagramCard};
